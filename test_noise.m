...
for a=1:31
    for b =1:31
        for i=1:4
            for j=1:4
                if (0.5<y_sub_image{a,b}(i,j)<10)
                    r = y_sub_image{a,b}(i,j)*0.999;
                    y_sub_image{a,b}(i,j)=y_sub_image{a,b}(i,j)+noise(1,1,0,r);            
                end 
            end
        end
    end
...
imwrite(final_img_compressed,strcat('C:\Users\sarbajit\Desktop\JPEG\test\4_32\random_noise\4_32_random_noise\random_noise_999\compressed_image\',sprintf('compressed%d.tif',z)),'tif');
...
%figure(3);
%imshow(final_img);
imwrite(final_img,strcat('C:\Users\sarbajit\Desktop\JPEG\test\4_32\random_noise\4_32_random_noise\random_noise_999\decompressed_image\',sprintf('decompressed%d.tif',z)),'tif');
%{ 
figure(4);
subplot(3, 1, 1);
title('Y - luma');
