...
imwrite(final_img_compressed,strcat('C:\Users\sarbajit\Desktop\JPEG\test\4_32\random_noise\test\',sprintf('compressed%d.tif',2)),'tif');
...
figure(3);
imshow(final_img);
imwrite(final_img,strcat('C:\Users\sarbajit\Desktop\JPEG\test\4_32\random_noise\test\',sprintf('decompressed%d.tif',2)),'tif');
%{ 
figure(4);
subplot(3, 1, 1);
title('Y - luma');
